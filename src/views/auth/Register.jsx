    ...
    <Toaster/>
      <div className='w-[350px] text-[#d0d2d6] p-2'>
        ...
        <div className='bg-[#283046] p-4 rounded-md'>
          ...
          <p className='text-sm mb-3'>Please Register to Your Account and start Your Bussiness Journey</p>
          ...
          <form onSubmit={submit}>
            <div className='flex flex-col w-full gap-1 mb-3'>
              ...
              <input onChange={inputHandler} value={state.name} className='px-3 py-2 outline-none border border-slate-700 
              bg-transparent rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden'
                type='text' name='name' placeholder='Enter your name' id='name' required />
            </div>
            ...
            <div className='flex items-cemter  w-full gap-3 mb-3'>
              ...
              <label htmlFor='checkbox' className='ml-2'>I agree to Privacy Policy & Terms</label>

            </div>
            


            <button disabled={loader ? true : false} className='bg-blue-500 w-full hover:shadow-blue-500/20 hover:shadow-lg text-white 
             rounded-md px-7 py-2 mb-3 '> 
             
             {
                loader ? <PropagateLoader  color='#fff'
                 overrideStyle={overrideStyle} /> : "Signup" 
             }
            ...
            <div className='flex items-center mb-3 gap-3 justify-center'>
              <p>Already have Account ? <Link className='underline hover:text-white hover:rounded-md hover:w-4 hover:p-2 hover:pr-2  hover:bg-orange-700' to="/login"> Sign In here</Link>
              </p>
            </div>
