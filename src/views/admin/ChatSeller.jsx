      ...
      <div className="w-full bg-[#283046] px-4 py-4 rounded-md h-[calc(100vh-140px)]">
        <div className="flex w-full h-full relative">
              ...
              >
                ...
                <div className="flex justify-center items-start flex-col w-full">
                  <div className="flex justify-between items-center  w-full ">
                    <h2 className="text-base font-semibold">Zubair Ahmad</h2>
                  </div>
                </div>
              </div>
          ...
          <div className="w-full md:w-[calc(100-200px)] md:pl-4">
            <div className=" flex justify-between items center">
              {sellerId && (
                <div className="flex justify-start items-center gap-3">
                  ...
                  <h2 className="text-white font-semibold text-base"> zubair Ahmad</h2>
                </div>
              )}
            ...
            text-white py-1 px-2 rounded-sm"
                    >
                      <span>please verify my acount</span>
                    </div>
                    <div>
                      <img
                        className="w-[38px] h-[38px] border-white  max-w-[38px] p-[3px] rounded-full "
