          ...
          <tbody className='text-sm font-normal'>
              {
                  [1, 2, 3, 4, 5].map((d, i) => <tr className='border-b border-slate-700' key={i}>
                      ...
                      <td scope="row" className="py-2 px-4 font-normal whitespace-nowrap"><span>Zubair Ahmad</span></td>
                      
                      <td scope="row" className="py-2 px-4 font-normal whitespace-nowrap"><span>mallzone@gmail.com</span></td>
                      <td scope="row" className="py-2 px-4 font-normal whitespace-nowrap"><span>in-active</span></td>
