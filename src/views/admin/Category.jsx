...
// console.log(searchValue)
  ...
  return (
    <div className="px-2 lg:px-2 pt-5">
      <div className="flex lg:hidden justify-between items-center mb-5 p-4 bg-[#283046] rounded-md ">
        <h1 className="text-[#d0d2d6] font-semibold text-lg ">Categories</h1>
        <button
          onClick={() => setShow(true)}
          className="bg-indigo-500 sahdow-lg hover:shadow-indigo-500/50 px-4 py-2 cursor-pointer text-white rounded-sm text-lg"
        >
          Add
        </button>
      </div>
...
rounded-md text-[#d0d2d6]"
                    ...
                    <tr key={i}>
                      ...
                      >
                        <div className="flex justify-start items-center gap-4">
                          ...
                          <Link
                            className="p-[6px] bg-red-500 rounded 
        ...
        <div
          className={`w-[320px] lg:w-5/12 translate-x-100 lg:relative lg:right-0
                fixed ${
                  show
                    ? "right-0"
                    : "-right-[340px] z-[9999] top-0 translate-all duration-500"
                }`}
        >
          <div className="w-full p-5 ">
            <div className="bg-[#283046] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
              <div className="flex justify-between items-center mb-4">
                ...
                >
                  <GrClose className="text-[#d0d2d6] hover:p-1 hover:bg-red-600  hover:text-white hover:rounded-lg" />
                </div>
              </div>

              <form onSubmit={add_category}>
                <div className="flex flex-col w-full gap1 mb-3">
                ...
                <div>
                  ...
                  >
                    {imageShow ? 
                      <img className="w-full h-full" src={imageShow} />  : <>  <span> <BsImage /> </span>
             ...
             {
                loader ? <PropagateLoader  color='#fff' overrideStyle={overrideStyle} /> : "Add Category" 
             }
