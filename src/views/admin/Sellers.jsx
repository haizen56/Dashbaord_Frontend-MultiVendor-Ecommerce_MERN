            ...
            <tbody className='text-sm font-normal'>
                {
                    [1, 2, 3, 4, 5].map((d, i) => <tr key={i}>
                        ...
                        <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap"><span>Zubair Ahmad</span></td>
                        <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap"><span>Lord Foods</span></td>
                        <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap"><span>pending</span></td>
                        <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap"><span>mallzone@gmail.com</span></td>
            
                        <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap"><span>Nadirabad</span></td>
                        <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap"><span>Lahore</span></td>
                        

                        <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">
                        
                        <div className='flex justify-start items-center gap-4'>
                        <Link to='/admin/dashboard/sellers/details/1' className='p-[6px] bg-green-500 rounded 
