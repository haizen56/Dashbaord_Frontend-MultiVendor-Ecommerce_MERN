      ...
      >
        ...
        <div className="flex justify-between items-center p-5 bg-[#283046]  rounded-md gap-3 ">
          <div className="flex flex-col justify-start items-start  text-[#d0d2d6]">
            ...
            <span className="text-sm font-normal">Available</span>
          </div>
          <div
            className="w-[45px] h-[47px]
            ...
            <form>
              <div className="flex gap-3 flex-wrap">
                <input
                  min="0"
                  type="number"
                  className="px-3 py-2 md:w-[79%] focus:border-indigo-500 outline-none bg-[#283046]
                   border border-slate-700
                    rounded-md text-[#d0d2d6]" name='amount'
                />
  <button className='bg-indigo-500 hover:shadow-indigo-500/50 hover:shadow-lg
               text-white   rounded-md px-4 py-2 my-2 text-md'>Submit</button>
              </div>
