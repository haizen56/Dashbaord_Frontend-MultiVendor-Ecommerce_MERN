    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4 bg-[#283046] rounded-md">
        <div className="flex justify-between items-center pb-4 ">
          <h2 className="text-white text-xl font-semibold">Edit Products</h2>
          <Link
            className="bg-blue-500 hover:shadow-blue-500
        ...
        <div>
          <form>
              ...
              <div className="flex flex-col w-full gap-1 relative">
                ...
                >
                  ...
                  >
                    {allCategory.map((c, i) => (
                      <span
                        className={`px-4 py-2 hover:bg-indigo-500 hover:text-white hover:shadow-lg 
            ...
            sm:grid-cols-3 gap-6 w-full text-[#d0d2d6] mb-4">
...

{
  imageShow.map((img,i)=> <div>
    ...
    <input className="hidden" onChange={(e)=> changeImage(img, e.target.files)} type="file" id={i} />
  </div>)
}
            ...
            <div className="flex">
              <button
                className="bg-blue-500  hover:shadow-blue-500/50 hover:shadow-lg
