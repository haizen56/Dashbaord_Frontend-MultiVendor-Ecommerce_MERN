          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-[#252b3b] md:bg-transparent overflow-y-auto">
              ...
              >
                ...
                <div className="flex justify-center items-start flex-col w-full">
                  <div className="flex justify-between items-center  w-full ">
                    <h2 className="text-base font-semibold">Zeeshan </h2>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex justify-center items-start flex-col w-full">
                  <div className="flex justify-between items-center  w-full ">
                    <h2 className="text-base font-semibold">Shehreyar</h2>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="flex justify-center items-start flex-col w-full">
                  <div className="flex justify-between items-center  w-full ">
                    <h2 className="text-base font-semibold">Napetitan</h2>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className=" flex justify-between items center">
              {sellerId && (
                <div className="flex justify-start items-center gap-3">
                  ...
                  <h2 className="text-base font-semibold text-white">Zeeshan</h2>
                </div>
              )}

              <div
                onClick={() => setShow(!show)}
                className="w-[35px] flex md:hidden h-[35px] bg-blue-500 shadow-lg hover:shadow-blue-500/50 rounded-sm justify-center cursor-pointer items-center text-white"
              >
                <span>
                  <FaList />
                </span>
